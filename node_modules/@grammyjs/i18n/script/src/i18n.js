...
class I18n {
    constructor(config) {
        ...
        this.fluent = new deps_js_1.Fluent(this.config.fluentOptions);
        if (config.directory) {
     ...
     */
    t(locale, key, context) {
        return this.translate(locale, key, context);
    }
    /** Gets a message by its key from the specified locale. */
    translate(locale, key, context) {
...
should either enable sessions or use `ctx.i18n.useLocale()` instead.");
        ...
        function translateWrapper(key, translationContext) {
