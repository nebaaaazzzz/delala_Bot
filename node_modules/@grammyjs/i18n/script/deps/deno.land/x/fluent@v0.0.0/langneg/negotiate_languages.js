...
exports.negotiateLanguages = void 0;
...
function negotiateLanguages(requestedLocales, availableLocales, { strategy = "filtering", defaultLocale } = {}) {
    const supportedLocales = (0, matches_js_1.filterMatches)(Array.from(Object(requestedLocales)).map(String), Array.from(Object(availableLocales)).map(String), strategy);
    if (strategy === "lookup") {
