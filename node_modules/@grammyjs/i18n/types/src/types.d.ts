import { Context, Fluent, FluentBundleOptions, FluentOptions, FluentVariable, LocaleId, TranslationContext } from "./deps.js";
export declare type LocaleNegotiator<C extends Context = Context> = (ctx: C) => LocaleId | undefined | PromiseLike<LocaleId | undefined>;
export declare type TranslateFunction = (key: string, context?: TranslationContext) => string;
